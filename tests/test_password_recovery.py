...
class TestPasswordRecovery:
    ...
    def test_go_to_forgot_password_page_successfully(self, login_page, forgot_password_page):
    ...
    def test_go_to_reset_password_page_successfully(self, forgot_password_page, reset_password_page):
    ...
    def test_make_field_active_on_reset_password_page_successfully(self, forgot_password_page, reset_password_page):
        forgot_password_page.open(URL.FORGOT_PASS_URL)
        forgot_password_page.set_email()
        forgot_password_page.click_on_recover_button()
